...
use crate::options::{
    ...
    McCabeOptions, Options, Pep8NamingOptions, PySparkOptions, PyUpgradeOptions,
    ...
    pub fn into_settings(self, project_root: &Path) -> Result<Settings> {
        ...
        Ok(Settings {
            ...
            linter: LinterSettings {
                ...
                pyspark: lint
                    .pyspark
                    .map(PySparkOptions::into_settings)
                    .unwrap_or_default(),
                pep8_naming: lint
                    .pep8_naming
...
impl LintConfiguration {
    fn from_options(options: LintOptions, project_root: &Path) -> Result<Self> {
        ...
        Ok(LintConfiguration {
            ...
            pyspark: options.common.pyspark,
